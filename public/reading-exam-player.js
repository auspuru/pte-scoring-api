(function (root, factory) {
  ...
  function isExam(session) { return !!session && (['full','mock','sectional-1','sectional-2','diagnostic'].includes(session.mode) || /^(?:(?:practice|sectional)-mock|reading-practice-mock)-[1-9]\d*$/.test(session.mode)); }
  ...
  function render({ session:s, question:q, metadata='', content, audio, timer, saved, notice }) {
