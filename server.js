...
const KNOWN_MISSPELLINGS = {
  ...
  'equiptment':'equipment','excede':'exceed','exercise':'exercise',
  ...
  'idiosyncracy':'idiosyncracy','imediate':'immediate','incidently':'incidentally',
...
async function aiGrade(summary, passage) {
  ...
  const systemPrompt = [
    ...
    '  STRICT FACTUAL ACCURACY: Any incorrect number, statistic, name, or fact = deduct that element.',
    '  Example: passage says 3.4x but student writes 34x = topic/conclusion NOT captured.',
    '',
    'GRAMMAR (0-2):',
